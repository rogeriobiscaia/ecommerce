								...
								<div class="col-md-12">
									...
									<div class="woocommerce-billing-fields">
										...
										<p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
                                            ...
                                            <input type="text" value="<?php echo htmlspecialchars( $cart["deszipcode"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" placeholder="0000-000" id="billing_address_1" name="zipcode" class="input-text ">
										...
										<div id="order_review" style="position: relative;">
											...
											<div id="payment">
												<div class="form-row place-order">
													<input type="submit" data-value="Place order" value="Continuar" id="place_order" name="woocommerce_checkout_place_order" formmethod="post" formaction="/order" class="button alt">
												</div>
												<div class="clear"></div>
											</div>
										</div>
