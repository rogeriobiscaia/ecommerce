          ...
          <div class="box-body">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <input type="text" class="form-control" id="desurl" name="desurl" placeholder="Digite o url do produto" value="<?php echo htmlspecialchars( $product["desurl"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
            </div>
